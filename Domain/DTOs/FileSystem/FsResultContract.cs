...
public static class FsResultContract
{
    ...
    public static readonly IReadOnlyDictionary<string, Type> ResultTypes =
        FileSystemOperations.All.ToDictionary(o => o.ToolName, o => o.ResultType, StringComparer.Ordinal);
    ...
    {
        error = null;
        // Fail closed: a name nobody recognises is a typo, and passing it would skip the check
