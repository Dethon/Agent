...
public class OneShotChatMessengerClientTests
{
    ...
    public async Task SendResponse_WithMessage_AccumulatesContent()
    {
        ...
        {
            // Act
            await client.SendResponse(1, response1, 1, CancellationToken.None);
            await client.SendResponse(1, response2, 1, CancellationToken.None);
    ...
    public async Task SendResponse_WithReasoning_WhenShowReasoningTrue_OutputsReasoning()
    {
        ...
        {
            // Act
            await client.SendResponse(1, response, 1, CancellationToken.None);
    ...
    public async Task SendResponse_WithMultipleChunks_ResetsCompletionTimer()
    {
        ...
        try
        {
            ...
            await client.SendResponse(1, new ChatResponseMessage { Message = "Chunk1" }, 1, CancellationToken.None);
            await Task.Delay(200);
            await client.SendResponse(1, new ChatResponseMessage { Message = "Chunk2" }, 1, CancellationToken.None);
            await Task.Delay(200);
            await client.SendResponse(1, new ChatResponseMessage { Message = "Chunk3" }, 1, CancellationToken.None);
    ...
    public async Task CreateThread_ReturnsOne()
    {
        ...
        // Act
        var threadId = await client.CreateThread(1, "Test", CancellationToken.None);
    ...
    public async Task DoesThreadExist_ReturnsTrue()
    {
        ...
        // Act
        var exists = await client.DoesThreadExist(1, 1, CancellationToken.None);
