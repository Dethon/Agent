...
public class WyomingSatelliteHostTests
{
    ...
    public async Task Hub_DialsSatelliteRunsAndStreams_TranscribesAndSendsTranscriptBack()
    {
        ...
        var dispatcher = new TranscriptDispatcher(
            emitter, publisher.Object, manager, new VoiceCommandMatcher(new CommandSettings()), -1.0, 0.6, -1.4, 2000, TimeProvider.System, NullLogger<TranscriptDispatcher>.Instance);
        ...
        bool runPipelineFirst)
    {
        ...
        var manager = new VoiceConversationManager(
            ...
            TimeSpan.FromMinutes(5), NullLogger<VoiceConversationManager>.Instance);
        var dispatcher = new TranscriptDispatcher(
            emitter, publisher.Object, manager, new VoiceCommandMatcher(new CommandSettings()), -1.0, 0.6, -1.4, 2000, TimeProvider.System,
    ...
    public async Task Hub_FollowUpEarlyMark_NoSpeechYet_KeepsMicOpenForLateSpeech()
    {
        ...
        var dispatcher = new TranscriptDispatcher(emitter, publisher.Object, manager, new VoiceCommandMatcher(new CommandSettings()), -1.0, 0.6, -1.4, 2000, TimeProvider.System, NullLogger<TranscriptDispatcher>.Instance);
        var sessions = new SatelliteSessionRegistry();
        var registry = new SatelliteRegistry(new Dictionary<string, SatelliteConfig>
        {
